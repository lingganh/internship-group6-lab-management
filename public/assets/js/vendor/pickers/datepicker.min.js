!function () {
    ...
    function re(t, i) {
        ...
        if (i.locale && (t.controls.todayBtn.textContent = i.locale.today, t.controls.clearBtn.textContent = i.locale.clear), void 0 !== i.todayBtn && (i.todayBtn ? _(t.controls.todayBtn) : W(t.controls.todayBtn, t.controls.todayBtn.parentElement.classList.add('today-btn-hidden'))), e(i, "minDate") || e(i, "maxDate")) {
            const { minDate: e, maxDate: i } = t.datepicker.config;
            t.controls.todayBtn.disabled = !a(c(), e, i)
        }
        void 0 !== i.clearBtn && (i.clearBtn ? _(t.controls.clearBtn) : W(t.controls.clearBtn, t.controls.clearBtn.parentElement.classList.add('clear-btn-hidden')))
    }
