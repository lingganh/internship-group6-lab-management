<div>
    ...
    {{-- MODAL TẠO / SỬA LỊCH – COVER GIAO DIỆN ĐĂNG KÝ LỊCH ADMIN --}}
    @auth
        <div id="eventModal" class="lab-modal">
            <div class="lab-modal-content register-card">
                ...
                <div class="modal-body pt-3 px-4 pb-4 register-page">
                    <form id="eventForm">
                        ...
                        <div class="row g-4">
                            ...
                            {{-- CỘT PHẢI: Thời gian + Lặp + File (CHỈ 1 NGÀY) --}}
                            <div class="col-12 col-md-6">
                                <div class="vstack gap-3 sticky-col">
                                    ...
                                    <div class="time-section">
                                        ...
                                        <div class="row g-3 align-items-end">
                                            ...
                                            {{-- Ẩn endDate, luôn = startDate trong JS --}}
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                ...
                                                <div class="small text-muted mt-1">
                                                    Để trống: chỉ tạo 1 lịch.
                                                </div>
                                            </div>

                                            {{-- Chọn thứ khi lặp tuần --}}
                ...
                <div class="modal-footer border-0 px-4 pb-4 pt-0">
                    <button
                        type="button"
                        class="btn register-btn register-btn-ghost me-2"
                        onclick="closeModal()"
                    >
                        Hủy
                    </button>
