<div>
    ...
    <div class="lab-calendar-page">
        @php
            $labMaintenance = $rooms->where('code', 'LAB-304')->first()?->status === 'maintenance';
        @endphp

        @if($labMaintenance)
            <div class="maintenance-banner">
                <i class="fa-solid fa-triangle-exclamation maintenance-icon"></i>
                <span>Phòng lab đang bảo trì - Không thể đăng ký lịch mới</span>
            </div>
        @endif
        ...
        <div class="lab-calendar-shell">
            <div class="lab-layout">
                <aside class="lab-sidebar">
                    @auth
                        <button type="button" 
                                class="create-btn js-open-create-event"
                                @if($labMaintenance) disabled style="opacity: 0.5; cursor: not-allowed;" @endif
                                @if($labMaintenance) title="Phòng lab đang bảo trì" @endif>
                            <i class="fa-solid fa-{{ $labMaintenance ? 'lock' : 'plus' }}"></i>
                            <span>{{ $labMaintenance ? 'Đang bảo trì' : 'Tạo sự kiện' }}</span>
                        </button>
                    @endauth
                ...
                <div class="lab-calendar-main">
                    <div class="lab-calendar-card {{ $labMaintenance ? 'calendar-disabled' : '' }}">
                        <div id="calendar"></div>
                        ...
                        @if($labMaintenance)
                            <div class="maintenance-overlay">
                                <div class="maintenance-message">
                                    ...
                                    <h5>Phòng lab đang bảo trì</h5>
                                    <p>Hiện tại không thể đăng ký hoặc chỉnh sửa lịch. Vui lòng quay lại sau.</p>
                                </div>
                            </div>
                        @endif
                    </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="vstack gap-3">
                                    <div>
                                        ...
                                        <input type="text" id="eventTitle" class="form-control register-control" placeholder="Nhập tiêu đề..." required>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <textarea id="eventDescription" rows="4" class="form-control register-control" placeholder="Nhập mô tả..."></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="vstack gap-3 sticky-col">
                                    <div class="time-section">
                                        ...
                                        <div class="row g-3 align-items-end">
                                            <div class="col-12 col-sm-4">
                                                ...
                                                <input type="date" id="eventStartDate" class="form-control register-control" required>
                                            </div>
                                            <div class="col-6 col-sm-4">
                                                <label class="form-label small fw-semibold text-dark mb-1">Giờ bắt đầu</label>
                                                <input type="time" id="eventStartTime" class="form-control register-control" required>
                                            </div>
                                            <div class="col-6 col-sm-4">
                                                <label class="form-label small fw-semibold text-dark mb-1">Giờ kết thúc</label>
                                                <input type="time" id="eventEndTime" class="form-control register-control" required>
                                            </div>
                                    ...
                                    <div class="repeat-section">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                ...
                                                <input type="date" id="eventRepeatUntil" class="form-control register-control">
                                    ...
                                    <div>
                                        ...
                                        <input type="file" id="eventFiles" name="files[]" multiple class="form-control register-control" accept=".pdf,.ppt,.pptx,.doc,.docx,.xls,.xlsx,.png,.jpg,.jpeg">
                ...
                <div class="lab-detail-grid">
                    ...
                    <div class="lab-detail-item">
                        ...
                        <div class="lab-detail-value d-flex align-items-center gap-2">
                            <span>
                                <i id="statusPendingIcon" class="fa-solid fa-clock" style="color:#f59e0b; display:none;"></i>
                                <i id="statusApprovedIcon" class="fa-solid fa-circle-check" style="color:#10b981; display:none;"></i>
                                <i id="statusCompletedIcon" class="fa-solid fa-check-double" style="color:#6366f1; display:none;"></i>
                                <i id="statusCancelledIcon" class="fa-solid fa-ban" style="color:#ef4444; display:none;"></i>
                            </span>
                ...
                @auth
                    ...
                    @else
                        <div class="alert alert-warning mb-0">
                            ...
                            Phòng lab đang bảo trì - Không thể chỉnh sửa
                        </div>
                    @endif
                @endauth
    ...
    <script>
        ...
        window.LAB_ROOMS = @json($rooms->map(fn($r) => [
            'code' => $r->code, 
            'name' => $r->name,
