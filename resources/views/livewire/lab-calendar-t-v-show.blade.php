<div wire:poll.300s="loadData">
    ...
    <style>
        ...
        /* Category colors */
        .event-work { background: #bc307b; color: white; }
        .event-seminar { background: #c4b517; color: white; }
        .event-other { background: #4d6d41; color: white; }
        
        /* Status colors */
        .event-approved { background: #10b981; color: white; }
        .event-completed { background: #6366f1; color: white; }
        ...
        .fc-timegrid-now-indicator-line {
            border-color: #ea4335 !important; /* Màu đỏ của Google */
        ...
        .fc-timegrid-now-indicator-line::before {
            content: "";
            position: absolute;
            left: -6px; /* Điều chỉnh để hình tròn nằm đè lên trục thời gian */
            top: -6px;  /* Căn giữa hình tròn với đường kẻ 2px */
            width: 12px;
            height: 12px;
