...
<div class="container">
    ...
    <div class="content">
        ...
        <p>Bạn đã đăng ký tài khoản Hệ thống quản lý quản lý phòng Lab. Để có thể tiếp tục đăng nhập, vui lòng nhấn vào nút dưới đây để xác minh tài khoản và thiết mật khẩu: </p>
        <a href="{{ route('setPassword', ['token' => $token]) }}" class="button">Xác minh tài khoản</a>
        <p><strong>Lưu ý:</strong></p>
        <ul>
            <li>Link này có hiệu lực trong <strong>60 phút</strong>.</li>
            <li>Hết hạn lúc: <strong>{{ $student->created_at->addMinutes(60)->format('H:i d/m/Y') }}</strong>.</li>
